                        ...
                        <table>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <input type="submit" name="update" class="btn btn-success btn-block" value="Update">                                    </form>
                                    </form>
                                </td>
                                    <td class="cart_price">${{$item->price * $item->quantity}}</td>
                ...
                <div class="col-lg-4">
                    ...
                    <div class="cart__total">
                        ...
                        <form action="{{URL::to('checkout')}}">
                            <input type="text" name="fullname" class="form-control mt-2" placeholder="Enter Fullname" id="" required/>
                            <input type="text" name="phone" class="form-control mt-2" placeholder="Enter phone" id="" required/>
                            <input type="text" name="adress" class="form-control mt-2" placeholder="Enter adress" id="" required/>
                            <input type="hidden" name="bill" class="form-control mt-2" value="{{$total}}" placeholder="Enter adress" id="" required/>
