          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="{{URL::to('viewtechnologiesimg')}}">View All</a></li>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="{{URL::to('insertportfolio')}}" method="POST" enctype="multipart/form-data">
        @csrf
            ...
            <div class="modal-content">
              ...
              <select name="cid" class="form-control" id="">
                <option value="">Select Category</option>
                    <option value="{{$item->id}}">Accessories</option>
