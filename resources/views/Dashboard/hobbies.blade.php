          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="{{URL::to('hobbiesview')}}">View All</a></li>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="{{URL::to('addhobbies')}}" method="POST" enctype="multipart/form-data">
        @csrf
        <label for="">Title</label>
        <input type="text" name="description" placeholder="Enter Name" class="form-control mb-2" id="">
      ...
      <div class="modal" id="updatemodel{{$i}}">
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <input type="text" name="designation" value="{{$item->designation}}" placeholder="Enter Price" class="form-control mb-2" id="">
...
<td><a href="{{URL::to('hobbiesdelete/'.$item->id)}}" class="btn btn-danger">Delete</a></td>
                    </tr>
                   @endforeach
