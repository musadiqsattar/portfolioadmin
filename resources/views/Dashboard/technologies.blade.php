          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="{{URL::to('viewtechnologies')}}">View All</a></li>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-header">
          <h4 class="modal-title">Add New Name & Designation</h4>
        ...
        <div class="modal-body">
          ...
          <form action="{{URL::to('inserttechnology')}}" method="POST" enctype="multipart/form-data">
        @csrf
        <label for="">Title</label>
        <input type="text" name="name" placeholder="Enter Technology" class="form-control mb-2" id="">
        <label for="">Picture</label>
        <input type="file" name="file[]" class="form-control mb-2" id="" multiple>
        <label for="">Title</label>
        <input type="text" name="name[0]" placeholder="Enter Technology" class="form-control mb-2" id="">
         <label for="">Picture</label>
        <input type="file" name="file[]" class="form-control mb-2" id="" multiple>
        <label for="">Title</label>
        <input type="text" name="name[1]" placeholder="Enter Technology" class="form-control mb-2" id="">
         <label for="">Picture</label>
        <input type="file" name="file[]" class="form-control mb-2" id="" multiple>
        <label for="">Title</label>
        <input type="text" name="name1" placeholder="Enter Technology" class="form-control mb-2" id="">
         <label for="">Picture</label>
        <input type="file" name="file[]" class="form-control mb-2" id="" multiple>
        <label for="">Title</label>
        <input type="text" name="name2" placeholder="Enter Technology" class="form-control mb-2" id="">
         <label for="">Picture</label>
        <input type="file" name="file[]" class="form-control mb-2" id="" multiple>
        <label for="">Title</label>
        <input type="text" name="name3" placeholder="Enter Technology" class="form-control mb-2" id="">
        
        {{-- <label for="">Price</label>
        <input type="text" name="description" placeholder="Enter Designation" class="form-control mb-2" id=""> --}}
      ...
      <div class="modal" id="updatemodel{{$i}}">
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <!-- Modal body -->
              <div class="modal-body">
                <form action="{{URL::to('updatedesignation')}}" method="POST" enctype="multipart/form-data">
              @csrf
              <label for="">Title</label>
              <input type="text" name="name" value="{{$item->name}}" placeholder="Enter Title" class="form-control mb-2" id="">
              {{-- <label for="">Picture</label> --}}
              {{-- <img src="{{URL::asset('uploads/products/'.$item->picture)}}" /> --}}
            ...
            <div style="position:relative;">
              ...
              <input type="text" name="designation" value="{{$item->description}}" placeholder="Enter Price" class="form-control mb-2" id="">
